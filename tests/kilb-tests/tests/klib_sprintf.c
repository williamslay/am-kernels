...
void test_sprintf() {
    ...
    sprintf(dest, "%5d", 42);
    check(strcmp(dest, "   42") == 0);

    sprintf(dest, "%05d", 42);
    check(strcmp(dest, "00042") == 0);
    ...
    sprintf(dest, "%x", 42);
    check(strcmp(dest, "2a") == 0);

    sprintf(dest, "%#08x", 42);
    check(strcmp(dest, "0x00002a") == 0);

    sprintf(dest, "%#8x", 42);
    check(strcmp(dest, "    0x2a") == 0);

    int *num = 0;
    num = (void *)0xdeadbeef;
    sprintf(dest, "%p", num);
    check(strcmp(dest, "0xdeadbeef") == 0);
}
